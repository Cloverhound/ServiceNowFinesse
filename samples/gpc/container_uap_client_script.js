...
function handleScreenPop(popData) {
	...
	if (employeeId == "123457" || caseId == "TestCaseID") {
		employeeId = "75059";
		caseId = "unknown";
    }
	...
	switch (assignmentGroup) {
		...
		case "ESC Employee Services":
			...
			break;
		default:
			assignmentGroupSysId = assignmentGroup || null;
			break;
	}
    ...
    if (employeeId && caseId == "unknown") {
		...
		var employeeSysId = openFrameConfig.guestUserSysId || "5136503cc611227c0183e96598c4f706"; // 'guest' user sys id
